...
postRouter.post("/",(req,res,next)=>
{
    if(req.headers.token)
    {
        try
        {
            ...
            let newPost = postArray.find(u=>u.postId===req.body.postId)
            ...
            else if(req.body.content)
            {
                ...
                newPost = new Post(req.body.postId, newDate, req.body.title, req.body.content, currentUser, req.body.headerImage, newDate);
...
{
    let foundPost = postArray.find(u=>u.postId.toString().toLowerCase()===req.params.postId.toLocaleLowerCase());
    if( foundPost == undefined)
    {
